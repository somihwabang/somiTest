const data = {
	...
	"humanitiesDetail": [
		...
		"next": ["독어독문", "영어영문", "중어중문", "일본지역문화학과", "국어국문", "불어불문"]
		}
	],
	"social": [
		{
		...
		"next": ["정치외교학과", "행정학과", "무역학부", "경제학과", "소비자학과", "경영학과"]
		},
		{
		"id": 18,
		...
		"next": ["문헌정보학과", "미디어커뮤니케이션학과", "사회복지학과", "창의인재개발학과", "정치외교학과", "행정학과", "무역학부", "경제학과", "소비자학과", "경영학과", "데이터과학과", "세무회계학과"]
		}
	],
	"art": [
		{
	...
	"engineering": [
		...
		"next": ["건설환경공학전공", "에너지화학공학과", "바이오-로봇시스템공학과", "환경공학전공", "도시공학과", "컴퓨터공학과", "도시건축학"]
		},
		{
		"id": 33,
		...
		"next": ["기계공학과", "전기공학과", "산업경영공학과", "신소재공학과", "안전공학과", "에너지화학공학과", "바이오-로봇시스템공학과", "컴퓨터공학과", "환경공학전공", "도시공학과", "도시건축학", "건설환경공학전공"]
		}
	],
	"medical": [
		{
...
const infoList = [
	...
	},
	{
		...
		"learning": [
			{ "name": "생명과학과", "desc": "생명체의 구조, 기능, 발생, 진화 등을 연구하여 생명 현상을 이해하는 학과예요" },
	...
	},
	{
		...
		"learning": [
			...
			{ "name": "경영학과", "desc": "기업이나 조직을 효율적으로 운영하고 관리하는데 필요한 이론과 기술을 연구하는 학과예요" },
