const data = {
		"commonQuestions": [
			{
				...
				"options": [
					...
					"어떻게 지정 좌표계로 고정하셨죠?<br>흥미로운 이야기를 담은 과학책"
				],
		...
		"humanitiesDetail": [
			...
			},
			{
				...
				"options": [
					...
					"한국의 노래: 조선 시대 가사부터<br>현대 K-POP까지",
					"불어로 읽는 프랑스 영화와 연극"
				],
				"next": ["독어독문학과", "영어영문학과", "중어중국학과", "일본지역문화학과", "국어국문학과", "불어불문학과"]
			}
		],
		"social": [
			{
		...
		"engineering": [
			...
			},
			{
				...
				"next": ["에너지화학공학과", "바이오-로봇시스템공학과", "환경공학전공", "컴퓨터공학부"]
			},
			{
				"id": 30,
			...
			},
			{
				...
				"next": ["건설환경공학전공", "에너지화학공학과", "바이오-로봇시스템공학과", "환경공학전공", "도시공학과", "컴퓨터공학부", "도시건축학전공"]
			},
			{
				"id": 33,
				...
				"next": ["기계공학과", "전기공학과", "산업경영공학과", "신소재공학과", "안전공학과", "에너지화학공학과", "바이오-로봇시스템공학과", "컴퓨터공학부", "환경공학전공", "도시공학과", "도시건축학전공", "건설환경공학전공"]
			}
		],
		"medical": [
			{
...
const infoList = [
	...
	},
	{
		...
		"learning": [
			...
			{ "name": "기계공학과", "desc": "인류의 생활을 편리하고 윤택하게 하는 다양한 종류의 기계를 설계, 제작, 해석, 제어하는 학과예요." }
		]
	},
	{
		"major": "수의대",
	...
	},
	{
		...
		"learning": [
			...
			{ "name": "물리학과", "desc": "자연계의 기본 원리에 대한 이론과 실험을 통해 자연현상을 이해하고, 전문 인력을 배출하는 학과예요." }
		]
	},
	{
		"major": "한의대",
	...
	},
	{
		...
		"learning": [
			...
			{ "name": "경영학부", "desc": "기업이나 조직을 효율적으로 운영하고 관리하는 데 필요한 이론과 기술을 연구하는 학과예요." },
			{ "name": "행정학과", "desc": "정부 및 공공기관의 조직, 정책, 운영 등을 연구하는 학과예요." }
		]
	},
	{
		"major": "국어국문학과",
		"desc": "국어국문학과는 한국어와 한국 문학을 체계적으로 연구하며, 국어학과 국문학을 통해 민족 문화의 창달에 기여하는 것을 목표로 합니다.",
		"learning": [
			...
			{ "name": "일본지역문화학과", "desc": "일본 지역 및 문화 전반에 대해 통찰력을 가진 융합적인 인재를 배출하는 학과예요." }
		]
	},
	{
		"major": "독어독문학과",
		...
		"learning": [
			{ "name": "국어국문학과", "desc": "인문학적인 지식과 국제적인 시각을 갖춰 다양한 문화 간에 교류할 수 있는 능력을 키우는 학과예요." },
			{ "name": "영어영문학과", "desc": "영어영문학을 기반으로 국제적으로 의사소통할 수 있는 능력을 기르는 학과예요." },
	...
	},
	{
		...
		"learning": [
			{ "name": "기계공학과", "desc": "인류의 생활을 편리하고 윤택하게 하는 다양한 종류의 기계를 설계, 제작, 해석, 제어하는 학과예요." },
			{ "name": "수학과", "desc": "수학의 기본 원리를 이해하는 창조적 사고를 지닌 전문인을 육성하는 학과예요." },
			{ "name": "해양학과", "desc": "바다와 그 안의 생물, 해양환경 등을 연구하여 지구의 바다에 대한 이해를 증진시키는 학과예요." }
		]
	},
	{
	...
	{
		"major": "중어중국학과",
		"desc": "중어중국학과는 중국어와 중국 문학을 연구하며, 중국어의 언어적 특성과 문학적 작품을 통해 중국 문화를 이해하는 것을 목표로 합니다.",
		"learning": [
			{ "name": "국어국문학과", "desc": "인문학적인 지식과 국제적인 시각을 갖춰 다양한 문화 간에 교류할 수 있는 능력을 키우는 학과예요." },
			{ "name": "불어불문학과", "desc": "프랑스의 문화, 예술, 사회 등을 체험함으로써 세계를 폭넓게 이해할 수 있는 인재를 배출하는 학과예요." },
			{ "name": "영어영문학과", "desc": "영어영문학을 기반으로 국제적으로 의사소통할 수 있는 능력을 기르는 학과예요." }
	...
	},
	{
		...
		"learning": [
			{ "name": "건설환경공학전공", "desc": "국토의 개발 및 보전, 환경 문제, 교통 계획 및 시설, 수자원 개발, 도시 계획에 기여하는 인재를 육성하는 학과예요." },
	...
	},
	{
		...
		"learning": [
			{ "name": "데이터과학과", "desc": "데이터과학과는 대량의 데이터를 수집, 분석하고 해석하여 유용한 정보를 추출하는 데 중점을 두는 학과예요." },
			{ "name": "무역학부", "desc": "무역 정책, 국제 경제 관계 등을 연구하고 학습하는 학과예요." },
			{ "name": "경영학부", "desc": "경영학부는 기업이나 조직을 효율적으로 운영하고 관리하는 데 필요한 이론과 기술을 연구하는 학과예요." }
		]
	},
	{
		"major": "수학교육과",
	...
	},
	{
		...
		"learning": [
			{ "name": "환경공학전공", "desc": "환경 보호와 지속 가능한 발전을 위해 환경과 관련된 다양한 문제를 해결하는 데 초점을 둔 학과예요." },
			{ "name": "산업경영공학과", "desc": "생산 및 운영 프로세스를 최적화하고 조직을 효율적으로 관리하는 데 필요한 이론과 기술을 연구하는 학과예요." },
			{ "name": "건설환경공학전공", "desc": "국토의 개발 및 보전, 환경 문제, 교통 계획 및 시설, 수자원 개발, 도시 계획에 기여하는 인재를 육성하는 학과예요." }
		]
	},
	{
	...
	},
	{
		...
		"learning": [
			{ "name": "데이터과학과", "desc": "대량의 데이터를 수집, 분석하고 해석하여 유용한 정보를 추출하는 데 중점을 두는 학과예요." },
			{ "name": "무역학부", "desc": "무역 정책, 국제 경제 관계 등을 연구하고 학습하는 학과예요." },
	...
	},
	{
		...
		"learning": [
			...
			{ "name": "디자인학부", "desc": "시공간적 사물이나 환경을 창조하고 형성하는 데 사용되는 다양한 디자인 원리와 기술을 배우는 학과예요." },
			{ "name": "데이터과학과", "desc": "데이터과학과는 대량의 데이터를 수집, 분석하고 해석하여 유용한 정보를 추출하는 데 중점을 두는 학과예요." }
		]
	},
	{
