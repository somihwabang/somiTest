...
// //         }
// //         setTimeout(() => {
// //             const nextKey = data[currentQuestionSet][qIdx].next[idx];
...
// //     for (let i in data[currentQuestionSet][currentQuestionIndex].options) {
// //         addAnswer(data[currentQuestionSet][currentQuestionIndex].options[i], currentQuestionIndex, i);
// //     }
...
//             } else if (currentQuestionSet === "scienceDetail") {
//                 selectedOptions.scienceDetail.push(nextKey);
//             }
